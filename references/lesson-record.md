# Compact Learning Record

Adapt the headings and language to the existing vault. These are content prompts, not required boilerplate. A small change can fit in one note; continuing work can update an existing one.
...
## Learning evidence and continuation
